...
repeatable R1 evidence, not the full R2 baseline: CPU, memory, Python reference
...
opens sockets; those remain Python adapter responsibilities.
...
and Python registry mutation remain adapter-owned.
...
remain Python adapter responsibilities.
...
values; argument binding, adaptive sampling, task cancellation, and Python
