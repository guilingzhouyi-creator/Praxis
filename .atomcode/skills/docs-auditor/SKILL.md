---
name: docs-auditor
description: Automated documentation audit for NOMOS Praxis. Scans diffs and files for CJK residue in comments/docstrings (excluding i18n data), missing module docstrings, and missing class/function docstrings per project conventions.
