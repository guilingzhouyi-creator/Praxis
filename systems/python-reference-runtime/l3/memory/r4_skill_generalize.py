...
class SkillGeneralizeMixin:
    ...
    _archive_before_evolve: Any
    _distill_lessons_skill: Any
    _fp_of: Any
    _persist_skill_md: Any
    _pmu: Any
    _sample_digest: Any
    _skill_md_path: Any
    _summarize_tool_lessons: Any
    agent_id: Any
    reflect_failure: Any
    ...
    def evolve_skill(
        ...
        Cell's white-list (evolution feeds back in) so its agents can inject it immediately.
        ...
        try:
            ...
            # Evolution feeds back in: bind the evolved skill to the originating Cell so its
