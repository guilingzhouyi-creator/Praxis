...
class CardDispatchMixin:
    ...
    # Host-provided attributes (declared by CardRegistry)
    _cards: Any
    _cell_map: Any
    _expose_card_execution: Any
    _find_dependents: Any
    _is_placeholder: Any
    _lock: Any
    _queue: Any
    _record_card_executions: Any
    _route_to_convention: Any
    complete: Any
    hold_card: Any
    _dispatcher_running: bool
    _dispatcher_thread: Any
