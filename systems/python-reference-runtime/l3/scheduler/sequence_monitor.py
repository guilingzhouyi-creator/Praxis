...
class SequenceMonitor:
    ...
    def _save(self) -> None:
        try:
            ...
            capture("seq_monitor save failed", error_code="E_SEQ_SAVE", component="sequence_monitor", exc=e)
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            capture("seq_monitor load failed", error_code="E_SEQ_LOAD", component="sequence_monitor", exc=e)
