    ...
    def load_builtin(self) -> int:
        ...
        for sd in dirs:
            if os.path.isabs(sd):
                ...
                # Relative path — try project root, then systems/python-reference-runtime/
                # kernel_dir = <root>/systems/python-reference-runtime/l1/kernel
                # → project root is 4 levels up.
                for base in [
                    os.path.join(kernel_dir, "..", "..", "..", ".."),  # project root
                    os.path.join(kernel_dir, "..", "..", ".."),  # systems/python-reference-runtime/
                ]:
