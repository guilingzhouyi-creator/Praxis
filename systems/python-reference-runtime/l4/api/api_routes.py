...
API_ROUTES: list[tuple[str, str, str, str]] = [
    ...
    (
        ...
        "/api/v2/posture",
        ".posture_matrix_get",
        "Posture matrix status (attack-posture configuration surface)",
    ),
    (
        "PUT",
        "/api/v2/posture",
        ".posture_matrix_set",
        "Set a domain's offensive posture + target whitelist",
    ),
    (
        "PUT",
        "/api/v2/posture/api",
        ".posture_api_enabled_set",
        "Flip the posture matrix API master switch",
    ),
    (
        "GET",
        "/api/v2/departments",
    ...
    (
        ...
        ".secretary_status",
        "L3A-C secretary status (mode/score)",
    ),
    (
        "GET",
        "/api/v2/memory/filter",
        ".memory_filter_get",
        "Memory domain-filter switch state (M1)",
    ),
    (
        "PUT",
        "/api/v2/memory/filter",
        ".memory_filter_set",
        "Enable/disable memory domain filtering (M1)",
    ),
    (
        # phase2d: decision-layer role + delegate (D2)
        "GET",
        "/api/v2/l3a/decision-layer",
        ".l3a_decision_layer_get",
        "L3A decision-layer role (first/second)",
    ),
    (
        "POST",
        "/api/v2/l3a/delegate",
        ".l3a_delegate_post",
        "L3A commissions a decision task (second-decision-layer)",
    ),
    (
        ...
        "/api/v2/l3a/secretary",
        ".secretary_update",
        "Toggle L3A-C secretary (enabled/threshold/mode)",
    ),
    (
        "POST",
        "/api/v2/l3a/secretary/contribute",
        ".secretary_contribute",
        "Record an L3A-C secretary contribution",
    ),
    (
        "GET",
        "/api/v2/review/threshold",
        ".review_threshold_get",
        "Review pipeline disposition settings",
    ),
    (
        "PUT",
        "/api/v2/review/threshold",
        ".review_threshold_set",
        "Adjust the small-change bypass threshold",
    ),
    (
        "GET",
        "/api/v2/diff/persist",
        ".diff_persist_get",
        "Diff-persist store statistics",
    ),
    (
        "PUT",
        "/api/v2/diff/persist",
        ".diff_persist_set",
        "Enable/disable the frontend-heavy diff persist store",
    ),
    (
        "GET",
        "/api/v2/diff/stitch",
        ".diff_persist_list",
        "Stitched diffs for frontend consumption",
    ),
    # Security evidence chain (attack-posture bypass analysis)
    (
        "GET",
        "/api/v2/security/evidence/chains",
        ".security_evidence_chains",
        "Evidence-chain index with verdicts (attack-posture bypass analysis)",
    ),
    (
        "GET",
        "/api/v2/security/evidence",
        ".security_evidence_query",
        "Query evidence points (chain_id / skill / phase / decision)",
    ),
    (
        "GET",
        "/api/v2/security/evidence/report",
        ".security_evidence_report",
        "Evidence-chain report (timeline + findings + fixity)",
    ),
    (
        "GET",
        "/api/v2/security/evidence/analyze",
        ".security_evidence_cross_analyze",
        "Cross-chain aggregate analysis (verdicts/decisions/skills)",
    ),
    ...
    (
        "GET",
        "/api/v2/memory/compression-guard",
    ...
    (
        ...
        "Set recursion threshold / breaker switch (B6)",
    ),
    # Shell
    ...
    ("POST", "/api/v2/tools/register", ".tool_register", "Dynamically register a tool"),
    ("POST", "/api/v2/tools/unregister", ".tool_unregister", "Unregister a dynamically registered tool"),
    ...
    (
        "POST",
        "/api/v2/diff/tier",
        "l4.api.api_handlers_diff.diff_tier",
        "Three-tier topology diff view (build/review/conflict)",
    ),
    ...
    # ── Identity Binding (Phase 1) ──
    (
        "GET",
        "/api/v2/identity-binding",
        "l4.api_handlers.api_handlers_identity.handle_identity_binding_get",
        "Get identity bindings",
    ),
    (
        "GET",
        "/api/v2/identity/set",
        "l4.api_handlers.api_handlers_identity.handle_identity_set_get",
        "Resolve an Agent's generic identity set (build/test/review)",
    ),
    (
        "PUT",
        "/api/v2/identity-binding",
        "l4.api_handlers.api_handlers_identity.handle_identity_binding_put",
        "Bind a role to a strict-role prompt fragment",
    ),
    (
        "DELETE",
        "/api/v2/identity-binding",
    ...
    (
        "POST",
        "/api/v2/skills/update-policy",
        "l4.api_handlers.api_handlers_skills.handle_skills_update_policy",
        "Adjust R4Agent skill update cadence (developer)",
    ),
    (
        "GET",
