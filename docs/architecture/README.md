...
| — | [quality-baseline.md](quality-baseline.md) | Per-layer quality gates: measured vs baseline scan (bench_layer_structure.py), hard/soft gate model |
| — | [perf-baseline.md](perf-baseline.md) | Per-layer performance gates: benchmark vs baseline scan (bench_layer_runtime.py), drift floor |
...
| L2 Shell | 44 files / 6,617 lines |
| L3 Cell | 351 files / 79,531 lines |
...
| Params modules / constants | 8 / 1,213 |
