...
| L2 Shell | 44 files / 5,905 lines |
| L3 Cell | 337 files / 73,588 lines |
| L4 Bridge | 113 files / 23,309 lines |
| L1 Kernel | 69 files / 18,196 lines |
| L2 Shell | 44 files / 5,905 lines |
| L3 Cell | 347 files / 77,134 lines |
| L4 Bridge | 113 files / 23,309 lines |
...
| L4 Handlers | 34 files / 6,330 lines |
...
| L3 Agent | 37 files / 8,651 lines |
| L4 Handlers | 34 files / 6,330 lines |
| API routes | 366 (`/api/v2/*` versioned) |
| Route domains | 46 (largest: memory=37, skill=27, system=18, security=18, provider=17) |
| Params modules / constants | 8 / 1,193 |
