...
is synced after rename where the host supports directory syncing; concurrent
updates are serialized per store. This is a filesystem-bearing R4 candidate
only: SettingsCenter discovery, provider
