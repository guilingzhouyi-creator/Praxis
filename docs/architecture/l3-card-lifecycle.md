...
follows one card end-to-end. 282 files across L3.
...
- **Agents**: `agent/` (27 files) — AgentLoop, Scout pool, SubAgent gate/
  pool, term handlers; `cell/components/` (26 files) — Cell, PMU, watchdog,
