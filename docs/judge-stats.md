...
**Runs**: 228 | **COMPLETE**: 34 (15%) | **PARTIAL**: 36 (16%, fast mode — checks skipped) | **INCOMPLETE**: 158 (69%, machine 'not done')
**Mode split**: full 91 / fast 137 (fast = at least one check skipped)
...
- `changelog`: 133 (84% of incomplete)
- `delta`: 70 (44% of incomplete)
...
- `index`: 199/211 (94%)
- `lint`: 161/214 (75%)
- `singleton`: 195/211 (92%)
- `tests`: 64/93 (69%)

**Numeric metrics** (latest / avg / min / max):
- `audit_vulns`: 0.0 / 0.0 / 0.0 / 0.0
- `coverage_pct`: 68.0 / 66.93 / 0.0 / 69.0
- `mega_funcs`: 3.0 / 12.97 / 0.0 / 256.0
- `net_delta`: 87.0 / 2287.56 / -4.0 / 27424.0
