...
**Runs**: 95 | **COMPLETE**: 5 (5%) | **PARTIAL**: 16 (17%, fast mode — checks skipped) | **INCOMPLETE**: 74 (78%, machine 'not done')
**Mode split**: full 15 / fast 80 (fast = at least one check skipped)
**Duration** (full runs): avg 357s / P95 636s (15 runs) — fast runs: avg 12s / P95 21s (80 runs)
...
- `mega_funcs`: 2.0 / 20.3 / 0.0 / 211.0
- `net_delta`: 0.0 / 414.12 / -2.0 / 3828.0
