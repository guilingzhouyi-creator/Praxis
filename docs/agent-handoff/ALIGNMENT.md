...
| 2026-08-25 | AGENTS.md + docs/contracts/kernel-contract.json + src/l1/* + src/l2/* + src/l3/* + src/l4/* | Antigravity (gemini-3.7-flash) | eliminate L1 transition shims (commands, model_registry, prompts), decouple L1 identity_binding via callback, reduce ALLOWLIST | in feature/system-refactor-phase1 (this commit) |
