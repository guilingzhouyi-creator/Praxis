...
| 2026-08-25 | crates/l1-kernel-rs/src/{runtime,benchmark_runner}.rs + crates/l1-kernel-rs/src/bin/{rust-runtime-bench,rust-runtime-batch-bench}.rs + crates/l1-kernel-rs/tests/{runtime,benchmark_runner}.rs + Makefile + docs/architecture/{l1-kernel,llms-full,multilang-build}.md + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | align feature onto main 06e8288c; retain protocol/conformance changes, update Runtime grouped-admission evidence to aligned-tree samples, and preserve no-runtime-authority boundary | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/{terminal_probe,process_constraints,process_group_runtime,lib}.rs + crates/l1-kernel-rs/tests/{terminal_probe,process_constraints}.rs + docs/architecture/{l1-kernel,multilang-build}.md + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | injected terminal capability discovery and fail-closed Agent process admission; constrained group spawn remains candidate-only with no host-path defaults or runtime authority | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/{platform,process_adapter,managed_process,process_bridge,process_group_runtime}.rs + crates/l1-kernel-rs/tests/process_adapter.rs + docs/architecture/{l1-kernel,multilang-build,llms-full}.txt + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | remove implicit Rust shell compatibility entry points, rename platform default-shell residue to selected-shell, and document direct argv plus terminal-observation execution boundary; split T5 removal from future Python/L2 cutover | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/platform.rs + crates/l1-kernel-rs/tests/platform.rs + docs/architecture/{l1-kernel,multilang-build}.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | remove PlatformDescriptor::shell_command so terminal argv construction has one probe-owned Rust seam; platform metadata remains provider-neutral | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/benchmark_runner.rs + crates/l1-kernel-rs/src/bin/{rust-process-adapter-bench,rust-managed-process-bench,rust-process-bridge-bench}.rs + crates/l1-kernel-rs/tests/benchmark_runner.rs + Makefile + docs/architecture/{l1-kernel,multilang-build,llms-full}.txt + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | remove process benchmark platform shell fallback; require injected direct argv and use an explicit self-child command in benchmark binaries; add fail-closed command validation | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/runtime.rs + crates/l1-kernel-rs/tests/runtime.rs + docs/architecture/{l1-kernel,multilang-build,llms-full}.txt + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | add bounded KernelRuntime::reap_finished report with terminal-only release and pending/unavailable/error accounting; keep reaper caller-owned and authority-free | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/process_bridge.rs + crates/l1-kernel-rs/tests/process_bridge.rs + docs/architecture/{l1-kernel,llms-full}.txt + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | bound ProcessTableBridge::reap_finished by an explicit budget, choose stable raw handles, reject zero budgets, and preserve terminal cleanup without production reaper authority | in feature/root-l1-runtime-perf |
| 2026-08-25 | crates/l1-kernel-rs/src/process_group_runtime.rs + crates/l1-kernel-rs/tests/process_group_runtime.rs + docs/architecture/{l1-kernel,multilang-build}.md + docs/architecture/llms-full.txt + docs/design/rust-first-kernel-rewrite.md + docs/roadmaps/frontend-kernel-roadmap.md | GPT (root-l1-runtime-perf) | require process.spawn plus matching gate/spec identity before constraints, audit GateChain denials, and reject correlation mismatches before spawn | in feature/root-l1-runtime-perf |
