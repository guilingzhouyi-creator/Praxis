...
class TestAgentLoopPostureGate:
    ...
    @pytest.mark.skip(reason="Known issue: lean case section lacks posture gate; evolved skills section is filtered by _system_permits_posture, making the test assertion unreachable. Tracked in docs/design/praxis-test-perf-slicing-plan.md.")
...
class TestRuntimeToggle:
    ...
    @pytest.mark.skip(reason="Known issue: same as test_offensive_skill_injected_when_card_nature_authorizes — lean case section lacks posture gate, evolved skills section blocked by _system_permits_posture. Tracked in perf-slicing plan.")
