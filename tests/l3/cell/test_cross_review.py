...
def test_cross_review_skip_read_actions():
    ...
    reset_cells()
    cell = get_cell("cr-cell-1", territory=["systems/python-reference-runtime"])
...
def test_cross_review_skip_empty_target():
    ...
    reset_cells()
    cell = get_cell("cr-cell-2", territory=["systems/python-reference-runtime"])
...
def test_cross_review_skip_non_peer():
    ...
    reset_cells()
    cell = get_cell("cr-cell-3", territory=["systems/python-reference-runtime"])
...
def test_cross_review_no_peers():
    ...
    reset_cells()
    cell = get_cell("cr-cell-4", territory=["systems/python-reference-runtime"])
