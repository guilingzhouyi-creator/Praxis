...
class TestFsApi:
    def test_tree(self, tmp_path):
        ...
        # count may exceed 3 when the conftest autouse singleton reset
        # pre-seeds runtime dirs (e.g. evolved-global/evolved-project) into
        # the tmp tree — assert presence, not an exact count.
        assert r["count"] >= 3
