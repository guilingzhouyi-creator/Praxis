...
class TestMiddlewareChain:
    ...
    def test_chain_handles_request(self):
        ...
        # "fr" is not a shipped translation locale (locales/ has en/zh-CN/ja/ko),
        # so a fully-registered I18nPort rejects it and falls back to the port
        # locale. Use "ja" — a real asset — so the query param always wins.
        req = Request(method="GET", path="/api/test", query={"locale": "ja"})
