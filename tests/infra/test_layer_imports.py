...
ALLOWLIST = {
    # L2→L3 command bridge — the single L3 boundary for the L2 shell (P1).
    ("l2/bridge.py", "l3.agent.agent_loop"),
    ("l2/bridge.py", "l3.agent.compression_guard"),
    ("l2/bridge.py", "l3.agent.digest_cache"),
    ("l2/bridge.py", "l3.agent.global_prompt_library"),
    ("l2/bridge.py", "l3.agent.prompt_library"),
    ("l2/bridge.py", "l3.agent.prompt_monitor"),
    ("l2/bridge.py", "l3.agent.sensitive_detect"),
    ("l2/bridge.py", "l3.agent.tool_result_cache"),
    ("l2/bridge.py", "l3.agent_terminal"),
    ("l2/bridge.py", "l3.bus.htn_a"),
    ("l2/bridge.py", "l3.bus.observability_bus"),
    ("l2/bridge.py", "l3.card.card_registry"),
    ("l2/bridge.py", "l3.cell"),
    ("l2/bridge.py", "l3.cell.department"),
    ("l2/bridge.py", "l3.cell.peers.l3"),
    ("l2/bridge.py", "l3.cell.peers.l3a.secretary"),
    ("l2/bridge.py", "l3.cell.violation_monitor"),
    ("l2/bridge.py", "l3.config.settings_center"),
    ("l2/bridge.py", "l3.error_bus"),
    ("l2/bridge.py", "l3.memory.memory"),
    ("l2/bridge.py", "l3.memory.memory_context"),
    ("l2/bridge.py", "l3.memory.memory_domain_filter"),
    ("l2/bridge.py", "l3.memory.memory_extract"),
    ("l2/bridge.py", "l3.memory.memory_graph"),
    ("l2/bridge.py", "l3.memory.memory_record_source"),
    ...
    ("l3/agent/agent_loop_guard.py", "l4.lsp.lsp_manager"),
    ...
    ("l3/tool_system/tool_pipeline_steps.py", "l4.sandbox.manager"),
