...
Regenerate after doc changes:  python scripts/py/gen_llms_txt.py
...
def main() -> None:
    ...
    lines.append("")
    lines.append("> Generated by scripts/py/gen_llms_txt.py — regenerate after doc changes.")
    ...
    chunks = [
        ...
        "> scripts/py/gen_llms_txt.py; regenerate after doc changes.\n",
    ]
