...
#
# Usage:
#   bash scripts/sh/check-worktree.sh [branch]        # verify current checkout
#   bash scripts/sh/check-worktree.sh                 # report current state
#   bash scripts/sh/check-worktree.sh --allow-dirty   # report but tolerate a dirty
