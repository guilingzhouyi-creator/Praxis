...
class MemoryIngestMixin:
    ...
    def remember(
        ...
        # Phase 3 M2/M4: write-path refinery — purify the stored entry and
        # persist modeling records to the TieredCache archive index (feeds
        # the RC memory source). Operator-gated; failures never affect the
        # main write flow.
        try:
            from .memory_refinery import refine_and_persist
