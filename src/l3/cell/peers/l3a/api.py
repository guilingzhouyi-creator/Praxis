...
_DISPATCHERS: dict[str, Callable[..., dict]] = {
    "agents-md": lambda a, m, r, c: _dispatch_agents_md(a),
    "create": lambda a, m, r, c: _dispatch_create(a, m, r, c),
    "resume": lambda a, m, r, c: _dispatch_resume(a, m, r, c),
    "list": lambda a, m, r, c: _dispatch_list(m),
    "info": lambda a, m, r, c: _dispatch_info(a, m),
    "close": lambda a, m, r, c: _dispatch_close(a, m),
    "messages": lambda a, m, r, c: _dispatch_messages(a, m),
    "model": lambda a, m, r, c: _dispatch_model(a, m, r, c),
    "context": lambda a, m, r, c: _dispatch_context(a, m, r, c),
    "tasks": lambda a, m, r, c: _dispatch_tasks(a, m),
    "todos": lambda a, m, r, c: _dispatch_todos(a, m),
    "convergence": lambda a, m, r, c: _dispatch_convergence(a),
    "convention": lambda a, m, r, c: _dispatch_convention(a),
    "summaries": lambda a, m, r, c: _dispatch_summaries(a),
    "compress": lambda a, m, r, c: _dispatch_compress(a, m),
    "memory": lambda a, m, r, c: _dispatch_memory(a, m),
    "compress-status": lambda a, m, r, c: _dispatch_compress_status(m),
    "compress-force": lambda a, m, r, c: _dispatch_compress_force(a, m),
    "ask": lambda a, m, r, c: _dispatch_ask(a, m),
    "ask-pending": lambda a, m, r, c: _dispatch_ask_pending(a),
    "answer": lambda a, m, r, c: _dispatch_answer(a, m),
}
