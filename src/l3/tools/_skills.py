    ...
    if skill_data.get("posture") == SKILL_POSTURE_OFFENSIVE:
        ...
        if not get_skill_manager().offensive_authorized(nature):
            ...
            try:
                ...
                pass
            # Evidence chain: the denial anchors to the active posture chain.
            try:
        ...
        # Evidence chain: granted offense use; a disabled policy is flagged as
        # a soft bypass (the bypass verdict is derived from this flag).
        try:
            ...
            record_evidence(
                ...
                target=name,
                source="use_skill",
                tags={"nature": nature, "soft_bypass": "0" if pol_enabled else "1"},
            )
        except Exception:
            pass
