...
# Max named sync objects held in the global registry; oldest free entries
# are evicted past this cap
SYNC_REGISTRY_MAX: Final[int] = 256
...
# Max backlog of consumed messages / orphan replies retained per LockChannel
# (handlers run synchronously, so retained entries are historical only)
IPC_CHANNEL_PENDING_MAX: Final[int] = 128
