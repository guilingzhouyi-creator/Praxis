...
# Max custom signal types that may be registered at runtime (memory bound)
SIGNAL_TYPE_REGISTRY_MAX: Final[int] = 256
# Max seconds to wait for the event-bus executor threads to drain on reset
EVENT_BUS_SHUTDOWN_TIMEOUT: Final[float] = 5.0
